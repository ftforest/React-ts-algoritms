...
export default function ReadLong({ title }: { title: string }) {
    ...
    const readDataForm = (e: React.ChangeEvent<any>): void => {
        ...
        let arrayFinel = ReadLongF(formJson.numberLong.toString(),1000,()=>console.log());
    ...
    return (
        <div>
            <h1>Read Long {title}</h1>
            <form method="post" onSubmit={readDataForm}>
                <input type="text" name="numberLong"/>
